...
(function(){
    var as = angular.module($appConfig.app.name, ['ngRoute', 'ngCookies', 'alv-ch-ng.i18n', 'alv-ch-ng.ui-forms', 'alv-ch-ng.ui-scroll', 'alv-ch-ng.ui-navigation', 'alv-ch-ng.ui-core', 'blueimp.fileupload','ngTextTruncate']);
